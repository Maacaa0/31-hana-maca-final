...
const shadowBg = document.querySelector(".shadow-background");
...
let historyImgsArray = Array.from(historyImgs);
  ...
  historyLink.forEach(link => {
    link.addEventListener("click", function() {
      ...
      shadowBg.classList.remove("display-none");
    })
  })

  historyCloseBtn.addEventListener("click", () => {
      historyContent.classList.add("hidden");
      shadowBg.classList.add("display-none");
  })
...
//     let currentPage = historyKeys.indexOf(historyTitle.textContent);
...
//     let currentPage = historyKeys.indexOf(historyTitle.textContent);
//     console.log(historyTitle.textContent)
// })
